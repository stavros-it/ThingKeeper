"""Settings dialog: backup folder, retention, auto-backup interval."""
...
class SettingsDialog(QDialog):
    ...
    def _save(self) -> None:
        ...
        if not raw:
            QMessageBox.warning(self, "Settings", "Backup folder cannot be empty.")
            return
        p = Path(raw)
        try:
            ...
            QMessageBox.warning(
                self, "Settings", f"Cannot create or write to folder:\n{exc}"
            )
            return
